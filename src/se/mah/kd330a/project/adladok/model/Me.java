...
public class Me {
	...
	/**
	 * Class for holding info about the currently logged in user.
	 */
	...
	public void startRefresher(FragmentCallback fragmentCallback, Context context) {
		mRefresh = new Refresh(fragmentCallback, context);
		mRefresh.execute();
	}
